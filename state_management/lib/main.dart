...
void main() => runApp(
      ChangeNotifierProvider<data>(
          create: (BuildContext context) => data(), child: MyApp()),
    );
    ...
    return Container(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Sehir:  ${Provider.of<data>(context).sehir}',
              style: TextStyle(fontSize: 20),
            )
          ],
        ));
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [
        ...
        Text(
          'Şehir: ${Provider.of<data>(context).sehir}',
          style: TextStyle(fontSize: 20),
        ),
        TextField(onChanged: (input) {
          Provider.of<data>(context, listen: false).degistir(input);
        })
      ]),
    );
  }
